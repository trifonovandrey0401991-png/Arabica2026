      ...
      child: Table(
        ...
        children: [
          TableRow(
            ...
            children: const [
              Padding(padding: EdgeInsets.all(12), child: Text('Тип отзыва', style: TextStyle(fontWeight: FontWeight.bold), textAlign: TextAlign.center)),
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [Icon(Icons.thumb_up, color: Colors.green, size: 20), const SizedBox(width: 8), const Text('Положительный')],
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(12),
                child: Text('+${_positivePoints.toStringAsFixed(2)}', textAlign: TextAlign.center, style: const TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
          TableRow(
            children: [
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [Icon(Icons.thumb_down, color: Colors.red, size: 20), const SizedBox(width: 8), const Text('Отрицательный')],
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(12),
                child: Text(_negativePoints.toStringAsFixed(2), textAlign: TextAlign.center, style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ],
