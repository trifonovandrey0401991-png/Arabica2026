/// Модель непройденной сдачи смены
class PendingShiftHandoverReport {
  ...
  /// Проверка, является ли сдача смены просроченной
  bool get isOverdue {
    ...
    // Только для сегодняшних сдач смен проверяем дедлайн
  ...
  factory PendingShiftHandoverReport.fromJson(Map<String, dynamic> json) {
    return PendingShiftHandoverReport(
      id: json['id'] ?? '',
