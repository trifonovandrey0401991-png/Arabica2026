...
│   ├── constants/ (3 файла)          ├── api/ (71 файлов)
│   ├── services/ (15 файлов)         ├── modules/ (9 файлов: OCR, vision, orders, z-report intelligence)
│   ├── theme/ (1 файл)               ├── ml/ (3 файла: YOLO inference, server, wrapper)
│   ├── widgets/ (1 файл)             ├── utils/ (15 файлов, вкл. db.js, push_service)
│   └── utils/ (5 файлов)             ├── services/ (1 файл: telegram)
├── features/ (36 модулей, 447 dart)  ├── PostgreSQL (arabica_db, ~44 таблиц)
├── shared/ (17 файлов)               └── /var/www/ (110+ директорий JSON, backup)
└── app/ (10 файлов)
```

**Ключевые числа:**
- 36 Flutter модулей (447 .dart файлов в features/, ~500 всего в lib/)
- 71 API файлов бэкенда (api/)
...
- 3 ML файла (ml/): YOLO inference, server, wrapper
...
```
Подключает 71 API файлов через require() и setup*()
...
### Полный список API файлов (71 штука)
