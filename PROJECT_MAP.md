...
> Дата обновления: 2026-03-01 (верифицировано по реальной файловой структуре)
...
│   ├── constants/ (4 файла)          ├── api/ (75 файлов: 63 обработчика + 9 планировщиков + 3 WebSocket)
...
│   ├── widgets/ (1 файл)             ├── utils/ (15 файлов, вкл. db.js, push_service)
│   └── utils/ (6 файлов)             ├── services/ (1 файл: telegram)
├── features/ (38 модулей, 463 dart)  ├── PostgreSQL (arabica_db, ~44 таблиц)
├── shared/ (18 файлов)               └── /var/www/ (110+ директорий JSON, backup)
└── app/ (12 файлов)
```

**Ключевые числа:**
- 38 Flutter модулей (463 .dart файлов в features/, 517 всего в lib/)
- 75 API файлов бэкенда (api/): 63 обработчика + 9 планировщиков + 3 WebSocket
- 11 автоматических планировщиков (schedulers) — ВСЕ в api/, НЕ в modules/
...
- 15 утилит бэкенда (utils/): кэш, пагинация, сессии, файловые операции, db.js, moscow_time, push_service, pending_notify и др.
...
| **messenger** | `features/messenger/` | 17 | BaseHttpService, ApiConstants, WebSocket |
...
### Утилиты бэкенда (utils/) — 15 файлов
...
### Полный список API файлов (76 штук)
